#calculate local magnitude (hypoDD format)
import obspy
import os
import math
    ...
    for lines in p:
        ...
        if string == '#':
            ...
            if i>0:
                ...
                net_var = np.var(mags)
                g.write('{} {} {} {} {} {} {} {} {} {} {} {} {} {} {}\n'.format('#', year0, mon0, day0, hour0, minute0, tmp0, lat0, lon0, dep0, round(float(net_mag),2),jk1_0,jk2_0,jk3_0,int(num)-1))
                print('{} {} {} {} {} {} {} {} {} {} {} {} {}\n'.format('#', year0, mon0, day0, hour0, minute0, tmp0, lat0, lon0, dep0, round(float(net_mag),2),round(float(net_var),2),int(num)-1))
                ...
                for stations in f:
                    ...
                    if sta==station:
                        ...
                        if phase == 'P':
                            ...
                            #te = tb + 1.7*0.73*(dist/6.0) #1.7*0.73*dist/6.0 is approximated to ts - tp, i.e., 1.7 times s-p
...
net_mag = np.median(mags)
net_var = np.var(mags)
g.write('{} {} {} {} {} {} {} {} {} {} {} {} {} {} {}\n'.format('#', year0, mon0, day0, hour0, minute0, tmp0, lat0, lon0, dep0, round(float(net_mag),2),jk1_0,jk2_0,jk3_0,int(num)))
print('{} {} {} {} {} {} {} {} {} {} {} {} {}\n'.format('#', year0, mon0, day0, hour0, minute0, tmp0, lat0, lon0, dep0, round(float(net_mag),2),round(float(net_var),2),int(num)))
for l in lines_out:
    g.writelines('{}'.format(l))
g.close()
